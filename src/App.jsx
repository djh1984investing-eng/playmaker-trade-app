...
useEffect(() => {
  ...
  const [aiSignalsLoaded, setAiSignalsLoaded] = useState(false);
...
const exportJournalCSV = () => {
  ...
  useEffect(() => {
    ...
    previousAnchorMapRef.current = currentAnchorMap;
  }, [activeAnchors, aiSignalsLoaded, seenNotificationKeys, submittedAnchorKeys, filledAnchorKeys]);
